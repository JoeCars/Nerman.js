...
-   **provider**: `ethers.JsonRpcProvider | string`. The blockchain network connection needed to store data. You can simply pass in a JSON RPC URL, or configure a custom provider if needed.
